    ...
    <div className="relative">
      ...
      {open && (
        ...
        >
          ...
          {/* 评论通知 */}
          <div className={`px-4 py-2.5 text-sm font-medium text-neutral-700 border-b sticky bg-white z-10 flex items-center justify-between ${
              notiItems.length > 0 ? 'top-[45px] border-t border-neutral-100' : 'top-0 rounded-t-xl'
            }`}>
