      ...
      {!getUserId() ? (
        ...
        <div className="space-y-3">
          {subs.map((s) => {
            ...
            return (
              <div key={s.id} className="flex items-center justify-between bg-white border border-neutral-200 rounded-xl p-4">
                ...
                <div className="flex items-center gap-3">
                  <span className={`text-xs font-semibold px-2.5 py-1 rounded-lg border ${statusColor(s)}`}>
                    {statusLabel(s)}
                  </span>
                  {valid && (
                    <button
