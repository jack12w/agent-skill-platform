...
const MENU = [
  ...
  { key: 'reviews',   label: '技能审核',           icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { key: 'tag-groups', label: '标签分组',           icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
    ...
    <div className="flex min-h-[calc(100vh-64px)]">
      ...
      <aside className="w-56 bg-white border-r border-gray-200 shrink-0 hidden md:block">
        <div className="px-5 py-5 border-b border-gray-100">
          <h2 className="text-sm font-semibold text-gray-900">SkillHub Hub</h2>
