        ...
        <table className="w-full text-sm">
          <thead className="bg-neutral-100 text-neutral-500 text-xs uppercase">
            <tr>
              ...
              <th className="px-4 py-3 text-left hidden lg:table-cell">{t('admin.thType')}</th>
          ...
          <tbody className="divide-y divide-neutral-100">
              ...
              <tr key={s.id} className="hover:bg-neutral-100">
                ...
                <td className="px-4 py-3 hidden lg:table-cell">
                  <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                    ...
                    {s.reviewType === 'version_update' ? t('admin.versionUpdate') : t('admin.newSubmission')}
                  </span>
                </td>
                <td className="px-4 py-3 hidden lg:table-cell">
            ...
            {(!data || data.items.length === 0) && (
              <tr><td colSpan={6} className="px-4 py-12 text-center text-neutral-400 text-sm">{t('admin.noPending')}</td></tr>
            )}
          </tbody>
        </table>
      </div>
